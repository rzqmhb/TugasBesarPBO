...
public class DaftarBarang extends javax.swing.JFrame {
    ...
    public DaftarBarang(int idPenjualan){
        initComponents();
        tampilkanData(idPenjualan);
    }
    
    public void tampilkanData(int idPenjualan){
        Object[] namaKolom = new Object[] {"ID","ID Barang","Nama Barang","Harga","Kuantitas"};
        ...
        for (BarangOrder barangOrder : listBarang){
            ...
            rowData[1] = barangOrder.getBarang().getIdBarang();
            rowData[2] = barangOrder.getBarang().getNama();
            rowData[3] = barangOrder.getHargaBarang();
            rowData[4] = barangOrder.getQtyBarang();
            
            model.addRow(rowData);
        }
        tblDaftarBarang.setModel(model);
    }
